...
All data files go in: `/Users/chris/code/gemini/sites/georgia_mining/data/research_materials/`

## Step 1: Check Existing Data

```bash
ls -la /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/
cat /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/MANIFEST.md
```
...
curl -s -L -A "GeorgiaGeoResearch/1.0 (academic)" "URL_HERE" -o /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/FILENAME

# Verify the download is real data, not an error page
file /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/FILENAME
head -5 /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/FILENAME

# If the file is HTML/error instead of data, DELETE IT IMMEDIATELY
rm /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/FILENAME
```
...
```bash
echo "| filename.csv | https://source-url... | $(date +%Y-%m-%d) | CSV | $(du -h filename.csv | cut -f1) | Brief description |" >> /Users/chris/code/gemini/sites/georgia_mining/data/research_materials/MANIFEST.md
```
