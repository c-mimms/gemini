...
- Check the existing articles directory at `/Users/chris/code/gemini/discord_bot/scripts/trump_articles/` (create it if it does not exist).
...
Save the file as `/Users/chris/code/gemini/discord_bot/scripts/trump_articles/YYYY-MM-DD_[slug].html` where `[slug]` is a short kebab-case name for the topic (e.g. `2026-03-09_immigrant-crime-rates.html`).
...
python3 /Users/chris/code/gemini/static_site/build_news.py \
  --source /Users/chris/code/gemini/discord_bot/scripts/trump_articles/ \
