...
1.  **Deduplicate Ideas**:
    -   Check the existing research logs in `/Users/chris/code/gemini/discord_bot/scripts/research/` (if the directory does not exist, you may create it).
...
4.  **Produce Research Document**:
    ...
    -   Save this report locally at `/Users/chris/code/gemini/discord_bot/scripts/research/YYY-MM-DD_[topic_name]_research.md` (replace the date and topic appropriately).
    
5.  **Publish Site**
    -   Run `python3 /Users/chris/code/gemini/static_site/build.py --source /Users/chris/code/gemini/discord_bot/scripts/research/ --s3-bucket s3://gemini-designs-portfolio-2026-v2/research/` to build and publish the site.
